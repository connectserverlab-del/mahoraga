...
const DOCS_URL = 'https://docs.mahoraga.com/features/use-with-claude-code'
...
export const MCPServerHeader: FC<MCPServerHeaderProps> = ({
  ...
  const handleRestart = async () => {
    ...
    try {
      const { getMahoragaAdapter } = await import('@/lib/mahoraga/adapter')
      const { MAHORAGA_PREFS } = await import('@/lib/mahoraga/prefs')
      const adapter = getMahoragaAdapter()
      await adapter.setPref(MAHORAGA_PREFS.RESTART_SERVER, true)
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="mb-1 flex items-center justify-between">
            <h2 className="font-semibold text-xl">Mahoraga MCP Server</h2>
            <a
              href={DOCS_URL}
              target="_blank"
          ...
          <p className="mb-6 text-muted-foreground text-sm">
            Connect Mahoraga to MCP clients like Claude Code, Gemini CLI and
            others.
          </p>
