...
function renderError(error: Error, providerType = 'mahoraga') {
...
describe('ChatError', () => {
  ...
  it('hides retry for Mahoraga daily-limit errors', () => {
    const html = renderError(
      new Error('Mahoraga LLM daily limit reached for today'),
    )
