...
import { MahoragaIcon, ProviderIcon } from '@/lib/llm-providers/providerIcons'
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          >
            ...
            ) : selectedProvider.type === 'mahoraga' ? (
              <MahoragaIcon size={18} />
            ) : (
              <ProviderIcon
        ...
        {selectedProvider.type === 'mahoraga' && <CreditsBadgeWrapper />}
      </div>
