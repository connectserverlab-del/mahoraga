...
export interface MahoragaAgentSession {
  key: string
  updatedAt: number
  sessionId: string
  agentId: string
...
export interface MahoragaChatHistoryToolCall {
  toolCallId?: string
  toolName: string
  label: string
  subject?: string
...
export interface MahoragaChatHistoryReasoning {
  text: string
  durationMs?: number
}

export interface MahoragaChatHistoryAttachment {
  kind: 'image' | 'file'
  mediaType: string
...
export interface MahoragaChatHistoryItem {
  id: string
  role: AgentChatRole
  text: string
  timestamp?: number
  ...
  tokensIn?: number
  tokensOut?: number
  toolCalls?: MahoragaChatHistoryToolCall[]
  reasoning?: MahoragaChatHistoryReasoning
  attachments?: MahoragaChatHistoryAttachment[]
}

export interface AgentHistoryPageResponse {
  agentId: string
  sessionKey: string | null
  session: MahoragaAgentSession | null
  items: MahoragaChatHistoryItem[]
  page: {
    cursor?: string
    hasMore: boolean
    limit: number
