...
function historyItem(
  overrides: Partial<MahoragaChatHistoryItem>,
): MahoragaChatHistoryItem {
  return {
    id: 'session-1:0',
    role: 'user',
    text: 'Hello',
...
function page(items: MahoragaChatHistoryItem[]): AgentHistoryPageResponse {
  return {
    agentId: 'main',
    sessionKey: 'session-1',
    session: null,
