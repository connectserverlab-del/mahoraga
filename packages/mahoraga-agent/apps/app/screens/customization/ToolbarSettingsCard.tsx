...
async function loadNativeToolbarSettingsState(): Promise<NativeToolbarSettingsState> {
  try {
    ...
    const [chatPref, labelsPref] = await Promise.all([
      adapter.getPref(MAHORAGA_PREFS.SHOW_LLM_CHAT),
      adapter.getPref(MAHORAGA_PREFS.SHOW_TOOLBAR_LABELS),
    ])
    ...
    const verticalTabsEnabled = supportsVerticalTabs
      ? (await adapter.getPref(MAHORAGA_PREFS.VERTICAL_TABS_ENABLED))
          ?.value !== false
      : true
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between border-border border-t pt-4">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              handleToggle(
                MAHORAGA_PREFS.SHOW_TOOLBAR_LABELS,
                checked,
        ...
        {supportsVerticalTabs && (
          <div className="flex items-center justify-between border-border border-t pt-4">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                handleToggle(
                  MAHORAGA_PREFS.VERTICAL_TABS_ENABLED,
                  checked,
