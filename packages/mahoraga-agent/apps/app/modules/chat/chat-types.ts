...
export const AGENT_SUGGESTIONS: Suggestion[] = [
  {
    ...
    prompt:
      'Go to https://dub.sh/mahoraga-launch in current tab. Find and click the upvote button',
    icon: '❤️',
  },
  {
    display: 'Support Mahoraga on Github',
    prompt:
      'Go to http://git.new/mahoraga in current tab and star the repository',
    icon: '⭐',
  },
  {
