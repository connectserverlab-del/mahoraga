...
const MockMahoragaAdapter = {
  getInstance: () => mahoragaAdapter,
}

const createMahoragaProvider = () => ({
  id: 'mahoraga',
  type: 'mahoraga',
  name: 'Mahoraga',
...
mock.module('@/lib/mahoraga/adapter', () => ({
  MahoragaAdapter: MockMahoragaAdapter,
...
mock.module('../../lib/llm-providers/storage', () => ({
  DEFAULT_PROVIDER_ID: 'mahoraga',
  createDefaultMahoragaProvider: createMahoragaProvider,
  createDefaultProvidersConfig: () => [createMahoragaProvider()],
