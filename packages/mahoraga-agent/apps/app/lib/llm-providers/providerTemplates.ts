...
export const providerTemplates: ProviderTemplate[] = [
  ...
  },
  {
    ...
    setupGuideUrl: 'https://docs.mahoraga.com/features/chatgpt-pro-oauth',
  },
  {
    id: 'github-copilot',
    name: 'GitHub Copilot',
    ...
    setupGuideUrl: 'https://docs.mahoraga.com/features/github-copilot-oauth',
  },
  {
    id: 'qwen-code',
    name: 'Qwen Code',
    ...
    setupGuideUrl: 'https://docs.mahoraga.com/features/qwen-code-oauth',
  },
  {
    id: 'moonshot',
    name: 'Moonshot AI',
  ...
  enrichTemplate('openai', {
    ...
    setupGuideUrl:
      'https://docs.mahoraga.com/features/bring-your-own-llm#openai',
  }),
  {
  ...
  enrichTemplate('anthropic', {
    ...
    setupGuideUrl:
      'https://docs.mahoraga.com/features/bring-your-own-llm#claude',
  }),
  enrichTemplate('google', {
    defaultModelId: 'gemini-2.5-flash',
    apiKeyUrl: 'https://aistudio.google.com/app/apikey',
    setupGuideUrl:
      'https://docs.mahoraga.com/features/bring-your-own-llm#gemini',
  }),
  {
    id: 'ollama',
    name: 'Ollama',
    ...
    contextWindow: 128000,
    setupGuideUrl:
      'https://docs.mahoraga.com/features/bring-your-own-llm#ollama',
  },
  enrichTemplate('openrouter', {
    defaultModelId: 'anthropic/claude-sonnet-4.5',
    apiKeyUrl: 'https://openrouter.ai/keys',
    setupGuideUrl:
      'https://docs.mahoraga.com/features/bring-your-own-llm#openrouter',
  }),
  enrichTemplate('lmstudio', {
    defaultModelId: 'openai/gpt-oss-20b',
    defaultBaseUrl: 'http://localhost:1234/v1',
    setupGuideUrl:
      'https://docs.mahoraga.com/features/bring-your-own-llm#lmstudio',
  }),
