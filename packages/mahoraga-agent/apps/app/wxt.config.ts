...
import { parseMahoragaApiUrl } from './lib/mahoraga-api-url'
...
const apiUrl = new URL(parseMahoragaApiUrl(env.VITE_PUBLIC_MAHORAGA_API))
...
export default defineConfig({
  ...
  manifest: {
    ...
    update_url: 'https://cdn.mahoraga.com/extensions/update-manifest.xml',
    // update_url: 'https://cdn.mahoraga.com/extensions/update-manifest.alpha.xml',
