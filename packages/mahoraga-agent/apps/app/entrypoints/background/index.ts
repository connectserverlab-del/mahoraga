...
import { Capabilities } from '@/lib/mahoraga/capabilities'
import { getHealthCheckUrl, getMcpServerUrl } from '@/lib/mahoraga/helpers'
import {
  ...
  toggleSidePanel,
} from '@/lib/mahoraga/toggleSidePanel'
import { checkAndShowChangelog } from '@/lib/changelog/changelog-notifier'
import {
  setupLlmProvidersBackupToMahoraga,
