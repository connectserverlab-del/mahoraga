...
const GLOW_OVERLAY_ID = 'mahoraga-glow-overlay'
const GLOW_STYLES_ID = 'mahoraga-glow-styles'
const GLOW_STOP_BTN_ID = 'mahoraga-glow-stop-btn'
...
function injectStyles(): void {
  ...
  style.textContent = `
    ...
    @keyframes mahoraga-glow-fade-in {
      from { opacity: 0; }
      to { opacity: ${GLOW_OPACITY}; }
    }

    @keyframes mahoraga-glow-btn-fade-in {
      from { opacity: 0; }
      to { opacity: 1; }
    }
    ...
    #${GLOW_OVERLAY_ID} {
      ...
      will-change: opacity;
      animation:
        mahoraga-glow-pulse 3s ease-in-out infinite,
        mahoraga-glow-fade-in 420ms cubic-bezier(0.22, 1, 0.36, 1) forwards !important;
    }
    ...
    #${GLOW_STOP_BTN_ID} {
      ...
      opacity: 0;
      animation: mahoraga-glow-btn-fade-in 420ms cubic-bezier(0.22, 1, 0.36, 1) forwards !important;
    }
