 ...
 * versioned Cloudflare R2 objects through the Mahoraga CDN. Chromium
 ...
 * versioned in `packages/mahoraga-agent/packages/onboarding-video/`;
 ...
 * `https://cdn.mahoraga.com`. That indirection keeps the extension
 * bundle small and the repo history clean.
 *
 * To bump the video:
 *
 *   1. Edit the composition source in
 *      `packages/mahoraga-agent/packages/onboarding-video/`.
 *
...
const CDN_BASE_URL = 'https://cdn.mahoraga.com'
