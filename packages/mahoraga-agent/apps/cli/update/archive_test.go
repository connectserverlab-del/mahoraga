...
func TestExtractBinaryTarGz(t *testing.T) {
	archive := createTarGz(t, map[string]string{"mahoraga-cli": "new-binary"})
...
func TestExtractBinaryZip(t *testing.T) {
	archive := createZip(t, map[string]string{"mahoraga-cli.exe": "new-binary"})
...
func TestExtractBinaryTarGzRejectsMultipleFiles(t *testing.T) {
	archive := createTarGz(t, map[string]string{
		"mahoraga-cli":     "new-binary",
		"mahoraga-cli.sig": "signature",
	})
...
func TestApplyBinary(t *testing.T) {
	targetPath := filepath.Join(t.TempDir(), "mahoraga-cli")
...
func TestVerifyThenApplyIntegration(t *testing.T) {
	archive := createTarGz(t, map[string]string{"mahoraga-cli": "updated-binary"})
