...
Example — search Gmail:
  mahoraga-cli strata check gmail
  mahoraga-cli strata discover "search emails" gmail
  mahoraga-cli strata actions GMAIL_EMAIL
  mahoraga-cli strata details GMAIL_EMAIL gmail_search_emails
  mahoraga-cli strata exec gmail GMAIL_EMAIL gmail_search_emails \
