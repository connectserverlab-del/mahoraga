 ...
 *
 * Renders, parses, and splices the Mahoraga-managed block inside the
...
const BEGIN = '<!-- MAHORAGA:BEGIN -->'
const END = '<!-- MAHORAGA:END -->'
const HASH_LINE_RE = /<!-- MAHORAGA:HASH=([0-9a-f]+) -->/
