...
import { CONTENT_LIMITS } from '@mahoraga/shared/constants/limits'
import type { LoggerInterface, LogLevel } from '@mahoraga/shared/types/logger'
import pino from 'pino'

const isDev = process.env.NODE_ENV === 'development'
const LOG_FILE_NAME = 'mahoraga-server.log'
