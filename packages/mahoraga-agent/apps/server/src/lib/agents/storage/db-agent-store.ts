...
import { type MahoragaDatabase, getDb } from '../../db'
...
/** Persists Mahoraga-owned harness agent definitions in the process SQLite database. */
export class DbAgentStore implements AgentStore {
  private readonly db: MahoragaDatabase
  private writeQueue: Promise<unknown> = Promise.resolve()

  constructor(options: { db?: MahoragaDatabase } = {}) {
