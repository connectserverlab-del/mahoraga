...
/** Resolves Mahoraga-packaged Claude/Codex binaries before falling back to host PATH. */
...
/** Prepends Mahoraga's packaged CLI directory so ACP packages spawn bundled CLIs first. */
