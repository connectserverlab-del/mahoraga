...
export function buildKlavisToolSet(deps: KlavisToolAdapterDeps): ToolSet {
  const toolSet: ToolSet = {
    connector_mcp_servers: {
      description:
        'Check or list Mahoraga managed app connectors before using Strata MCP tools. Omit server_name to see available, selected, connected, and proxy status. With server_name, returns connected/auth URL status.',
