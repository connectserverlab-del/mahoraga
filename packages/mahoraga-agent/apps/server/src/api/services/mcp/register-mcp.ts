...
import type { BrowserOutputFileAccess } from '@mahoraga/browser-mcp/output-file'
import {
  type BrowserToolDefaults,
  registerBrowserTools,
} from '@mahoraga/browser-mcp/register'
...
/** Registers Mahoraga MCP tools for the current request. */
