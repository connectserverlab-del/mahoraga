...
export class AgentHarnessService {
  ...
  constructor(
    ...
    this.mahoragaDir = deps.mahoragaDir ?? getMahoragaDir()
    ...
    this.runtime =
      ...
      new AcpxRuntime({
        ...
        mahoragaServerPort: deps.mahoragaServerPort,
      })
  ...
  async updateAgent(
    ...
    if (patch.name !== undefined) {
      ...
      const { AGENT_HARNESS_LIMITS } = await import(
        '@mahoraga/shared/constants/limits'
      )
  ...
  getActiveTurn(
    ...
    return { ...info, prompt: unwrapMahoragaAcpUserMessage(info.prompt) }
  }
