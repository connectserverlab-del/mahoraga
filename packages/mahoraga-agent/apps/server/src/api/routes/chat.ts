...
import { REMOTE_HERMES_PROVIDER_TYPE } from '@mahoraga/shared/constants/hermes'
...
interface ChatRouteDeps {
  ...
  /** Port the Mahoraga server bound to. Threaded to ACP providers so
   *  the spawned agent can dial back into the local /mcp route. */
  serverPort: number
  /** Mahoraga resources directory. Threaded to ACP providers so the
