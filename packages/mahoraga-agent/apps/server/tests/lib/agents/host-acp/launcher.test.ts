...
const FAKE_BUN_PATH = '/Volumes/Mahoraga/bin/third_party/bun'
const WINDOWS_BUN_PATH =
  'C:\\Users\\shadowfax\\AppData\\Local\\Mahoraga\\Application\\148.0.7947.97\\MahoragaServer\\default\\resources\\bin\\third_party\\bun.exe'
...
describe('resolveAcpSpawnCommand', () => {
  ...
  it('quotes the bundled bun path so paths with spaces survive', () => {
    const bunWithSpaces =
      '/Applications/Mahoraga App/Contents/bin/third party/bun'
    const out = resolveAcpSpawnCommand({
      agentType: 'claude',
      resourcesDir: '/Applications/Mahoraga.app/Contents/Resources',
