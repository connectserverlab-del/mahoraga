...
import type { TabGroup } from '@mahoraga/browser-core/tab-groups'
import { executeTool } from '@mahoraga/browser-mcp/tools/framework'
import { tab_groups } from '@mahoraga/browser-mcp/tools/tab-groups'
