...
import { captureScreenshotWithAnnotations } from '@mahoraga/browser-core/core/screenshot'
import { RefMap } from '@mahoraga/browser-core/core/snapshot/refs'
...
describe('captureScreenshotWithAnnotations', () => {
  ...
  it('runs the annotation lifecycle and returns annotation metadata when requested', async () => {
    ...
    expect(harness.expressions[1]).toContain(
      'data-mahoraga-screenshot-annotation',
    )
