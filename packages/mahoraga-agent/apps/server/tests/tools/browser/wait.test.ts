...
import type { ToolResponse } from '@mahoraga/browser-mcp/response'
import type { ToolContext } from '@mahoraga/browser-mcp/tools/framework'
import {
  DEFAULT_PAUSE_MS,
  parseWaitMs,
  wait,
} from '@mahoraga/browser-mcp/tools/wait'
