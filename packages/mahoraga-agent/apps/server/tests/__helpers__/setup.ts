...
/**
 * Ensures the full Mahoraga test environment is ready:
 ...
 */
export async function ensureMahoraga(
  ...
  console.log('\n=== Setting up Mahoraga test environment ===')
...
/**
 * Cleans up the full Mahoraga test environment.
 */
export async function cleanupMahoraga(): Promise<void> {
  console.log('\n=== Cleaning up Mahoraga test environment ===')
  await killBrowser()
  await killServer()
  runtimePlan = null
