...
import type { FrameRegistry } from '@mahoraga/browser-core/core/observer/frames'
import { Observer } from '@mahoraga/browser-core/core/observer/observer'
import type {
  PageManager,
  PageSession,
} from '@mahoraga/browser-core/core/pages'
