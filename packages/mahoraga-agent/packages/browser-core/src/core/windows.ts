import type { WindowInfo } from '@mahoraga/cdp-protocol/domains/browser'
...
/** Wraps Mahoraga window CDP commands for browser-core callers and tools. */
export class WindowManager {
  ...
  /** Changes visibility and returns the replacement window ID when Mahoraga swaps windows. */
  async setVisibility(
    windowId: number,
