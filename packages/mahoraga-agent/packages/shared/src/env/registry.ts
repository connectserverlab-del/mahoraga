...
export const ENV_REGISTRY: readonly EnvKeySpec[] = [
  ...
  },
  {
    key: 'MAHORAGA_BINARY',
    section: 'dev-tools',
    description: 'Mahoraga binary used by app and Claw development.',
    secret: false,
    schema: stringSchema,
    modes: {
      development: {
        value: '/Applications/Mahoraga.app/Contents/MacOS/Mahoraga',
      },
    },
  },
  {
    key: 'MAHORAGA_CDP_PORT',
    section: 'app',
  ...
  {
    key: 'MAHORAGA_SERVER_PORT',
    section: 'app',
    description:
      'Mahoraga server port, also used as the Claw browser launch port.',
    secret: false,
    schema: portSchema,
    modes: { development: { value: '9105' } },
  },
  {
    key: 'MAHORAGA_EXTENSION_PORT',
    section: 'app',
  ...
  {
    key: 'VITE_PUBLIC_MAHORAGA_API',
    section: 'app',
    description: 'Public Mahoraga API URL exposed to the browser bundle.',
    secret: false,
    schema: urlSchema,
    modes: { development: { value: 'https://api.mahoraga.com' } },
  },
  {
  ...
  {
    key: 'VITE_MAHORAGA_CLAW_API_URL',
    section: 'claw',
    description:
  ...
  {
    key: 'MAHORAGA_USER_DATA_DIR',
    section: 'claw',
    description:
      'Optional Chromium user data directory override for Claw dev browser launches.',
    secret: false,
    schema: stringSchema,
    modes: { development: { value: '/tmp/my-mahoraga-dev', commented: true } },
  },
  {
    key: 'MAHORAGA_CLAW_CDP_PORT',
    section: 'claw',
    description:
  ...
  {
    key: 'MAHORAGA_CONFIG_URL',
    section: 'server',
    description: 'Mahoraga server config URL required by production builds.',
    secret: false,
    schema: urlSchema,
    modes: {
      development: {
        value: 'https://llm.mahoraga.com/api/mahoraga-server/config',
      },
      production: {
        value: 'https://llm.mahoraga.com/api/mahoraga-server/config',
      },
  ...
  },
  {
    ...
    secret: false,
    schema: stringSchema,
    modes: { production: { value: 'mahoraga' } },
  },
  {
    key: 'ESIGNER_USERNAME',
    section: 'sign',
    description:
      'Mahoraga build eSigner username for Windows production signing.',
    secret: false,
    schema: stringSchema,
    modes: { production: { value: '' } },
  },
  {
    ...
    section: 'sign',
    description:
      'Mahoraga build eSigner password for Windows production signing.',
    secret: true,
    schema: stringSchema,
    modes: { production: { value: '' } },
  },
  {
    ...
    section: 'sign',
    description:
      'Mahoraga build eSigner TOTP secret for Windows production signing.',
    secret: true,
    schema: stringSchema,
    modes: { production: { value: '' } },
  },
  {
    ...
    section: 'sign',
    description:
      'Mahoraga build eSigner credential ID for Windows production signing.',
    secret: false,
    schema: stringSchema,
    modes: { production: { value: '' } },
  },
