...
(() => {
  var items = __MAHORAGA_ITEMS__;
  var attr = __MAHORAGA_ATTR__;
  var token = __MAHORAGA_TOKEN__;
  var useDocumentSpaceLabels = __MAHORAGA_FULL_PAGE__;
  var scroll = __MAHORAGA_SCROLL__;
