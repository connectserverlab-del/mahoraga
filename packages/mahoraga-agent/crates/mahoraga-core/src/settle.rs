...
(() => {
  const state = globalThis.__mahoraga_settle;
            ...
            Box::pin(async move {
                ...
                match method {
                    ...
                    "Runtime.evaluate" => {
                        ...
                        if expression.contains("__mahoraga_settle")
