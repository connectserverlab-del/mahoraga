...
/** Converts a models.dev model into the compact Mahoraga snapshot shape. */
...
/** Builds the Mahoraga provider snapshot from raw models.dev API data. */
export function generateModelsData(
  ...
  for (const [modelsDevId, mahoragaId] of Object.entries(providerMap)) {
    ...
    assertUniqueModels(mahoragaId, models)
...
/** Fetches live models.dev data and writes the checked-in Mahoraga snapshot. */
