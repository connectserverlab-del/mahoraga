      ...
      assets: [
        {
          ...
          url: 'https://cdn.mahoraga.com/artifacts/claw/onboarding-video/v0.1.0/first-run-demo.mp4',
        ...
        },
        {
          ...
          url: 'https://cdn.mahoraga.com/artifacts/claw/onboarding-video/v0.1.0/first-run-demo-poster.png',
          renderCommand:
