...
const repositoryUrl = 'https://github.test/connectserverlab-del/mahoraga'
...
describe('renderCappedChangelog', () => {
  ...
  it('keeps the newest fifteen entries and appends a compare link', () => {
    ...
    expect(result).toContain(
      '_Showing the latest 15 of 17 changes. [View the full changelog](https://github.test/connectserverlab-del/mahoraga/compare/claw-server%2Fv0.0.5...claw-server%2Fv0.0.6)._',
    )
  })
  ...
  it('encodes slash-containing release tags', () => {
    expect(
      buildCompareUrl({
        ...
        repositoryUrl: 'https://github.com/connectserverlab-del/mahoraga.git',
      }),
    ).toBe(
      'https://github.com/connectserverlab-del/mahoraga/compare/cli%2Fv0.4.0...cli%2Fv0.4.1',
    )
  })
  ...
  it('can build from GitHub Actions server and repository values', () => {
    expect(
      buildCompareUrl({
        ...
        githubRepository: '/connectserverlab-del/mahoraga/',
      }),
    ).toBe(
      'https://github.enterprise.test/connectserverlab-del/mahoraga/compare/claw-server%2Fv0.0.5...claw-server%2Fv0.0.6',
    )
  })
})
