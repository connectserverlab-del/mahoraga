...
+// Mahoraga: metrics prefs
+// String containing the stable client ID for Mahoraga metrics
+inline constexpr char kMahoragaMetricsClientId[] =
+    "mahoraga.metrics_client_id";
+
+// String containing the stable install ID for Mahoraga metrics (Local State)
+inline constexpr char kMahoragaMetricsInstallId[] =
+    "mahoraga.metrics_install_id";
+
+// NOTE: Other Mahoraga prefs have been moved to
+// chrome/browser/mahoraga/core/mahoraga_prefs.h
+
 }  // namespace prefs
