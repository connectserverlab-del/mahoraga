...
+    FPL("browserclaw");
+#else
+const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("mahoraga");
+#endif
...
+    FPL("browserclaw");
+#else
+const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("mahoraga");
+const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("mahoraga");
+#endif
 #endif  // OS_*
