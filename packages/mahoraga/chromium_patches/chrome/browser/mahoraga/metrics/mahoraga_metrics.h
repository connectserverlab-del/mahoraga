diff --git a/chrome/browser/mahoraga/metrics/mahoraga_metrics.h b/chrome/browser/mahoraga/metrics/mahoraga_metrics.h
new file mode 100644
index 0000000000000..7cac6786da901
--- /dev/null
+++ b/chrome/browser/mahoraga/metrics/mahoraga_metrics.h
@@ -0,0 +1,40 @@
+// Copyright 2025 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_MAHORAGA_METRICS_MAHORAGA_METRICS_H_
+#define CHROME_BROWSER_MAHORAGA_METRICS_MAHORAGA_METRICS_H_
+
+#include <string>
+#include <utility>
+
...
+
+// Simple static API for logging Mahoraga metrics.
+// Usage: MahoragaMetrics::Log("event.name");
+class MahoragaMetrics {
+ public:
...
+
+ private:
+  MahoragaMetrics() = delete;
+};
+
+}  // namespace mahoraga_metrics
+
+#endif  // CHROME_BROWSER_MAHORAGA_METRICS_MAHORAGA_METRICS_H_
