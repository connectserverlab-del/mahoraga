diff --git a/chrome/browser/mahoraga/server/server_process_launcher_unittest.cc b/chrome/browser/mahoraga/server/server_process_launcher_unittest.cc
new file mode 100644
index 0000000000000000000000000000000000000000..1446939a28f483e91db85293ad4021cc36c35a91
--- /dev/null
+++ b/chrome/browser/mahoraga/server/server_process_launcher_unittest.cc
@@ -0,0 +1,58 @@
