diff --git a/chrome/browser/mahoraga/server/mahoraga_server_constants.h b/chrome/browser/mahoraga/server/mahoraga_server_constants.h
new file mode 100644
index 0000000000000..8c9469cc988b5
--- /dev/null
+++ b/chrome/browser/mahoraga/server/mahoraga_server_constants.h
@@ -0,0 +1,48 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_MAHORAGA_SERVER_MAHORAGA_SERVER_CONSTANTS_H_
+#define CHROME_BROWSER_MAHORAGA_SERVER_MAHORAGA_SERVER_CONSTANTS_H_
+
...
+}  // namespace mahoraga_server
+
+#endif  // CHROME_BROWSER_MAHORAGA_SERVER_MAHORAGA_SERVER_CONSTANTS_H_
