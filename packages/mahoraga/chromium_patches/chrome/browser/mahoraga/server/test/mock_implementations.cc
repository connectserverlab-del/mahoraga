diff --git a/chrome/browser/mahoraga/server/test/mock_implementations.cc b/chrome/browser/mahoraga/server/test/mock_implementations.cc
new file mode 100644
index 0000000000000..3bef12ccf6617
--- /dev/null
+++ b/chrome/browser/mahoraga/server/test/mock_implementations.cc
@@ -0,0 +1,24 @@
