diff --git a/chrome/browser/mahoraga/server/server_state_store_impl.cc b/chrome/browser/mahoraga/server/server_state_store_impl.cc
new file mode 100644
index 0000000000000..76805b00dee0d
--- /dev/null
+++ b/chrome/browser/mahoraga/server/server_state_store_impl.cc
@@ -0,0 +1,25 @@
