diff --git a/chrome/browser/mahoraga/server/server_process_launcher_win.cc b/chrome/browser/mahoraga/server/server_process_launcher_win.cc
new file mode 100644
index 0000000000000000000000000000000000000000..69ccd172300d28bbe36817bf526711bb8c9ddb14
--- /dev/null
+++ b/chrome/browser/mahoraga/server/server_process_launcher_win.cc
@@ -0,0 +1,39 @@
...
+    DPLOG(ERROR) << "mahoraga: Failed to launch managed server";
+    return base::Process();
+  }
+
