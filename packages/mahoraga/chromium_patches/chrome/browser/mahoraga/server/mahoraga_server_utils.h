diff --git a/chrome/browser/mahoraga/server/mahoraga_server_utils.h b/chrome/browser/mahoraga/server/mahoraga_server_utils.h
new file mode 100644
index 0000000000000..6251f1274bcc6
--- /dev/null
+++ b/chrome/browser/mahoraga/server/mahoraga_server_utils.h
@@ -0,0 +1,89 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_MAHORAGA_SERVER_MAHORAGA_SERVER_UTILS_H_
+#define CHROME_BROWSER_MAHORAGA_SERVER_MAHORAGA_SERVER_UTILS_H_
+
+#include <optional>
+#include <set>
+#include <string>
...
+// =============================================================================
+
+// Returns the execution directory under user data (~/.mahoraga or equivalent).
...
+}  // namespace mahoraga::server_utils
+
+#endif  // CHROME_BROWSER_MAHORAGA_SERVER_MAHORAGA_SERVER_UTILS_H_
