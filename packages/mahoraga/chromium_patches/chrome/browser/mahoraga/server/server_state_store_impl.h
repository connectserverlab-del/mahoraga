diff --git a/chrome/browser/mahoraga/server/server_state_store_impl.h b/chrome/browser/mahoraga/server/server_state_store_impl.h
new file mode 100644
index 0000000000000..33b8015e18b03
--- /dev/null
+++ b/chrome/browser/mahoraga/server/server_state_store_impl.h
@@ -0,0 +1,30 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_MAHORAGA_SERVER_SERVER_STATE_STORE_IMPL_H_
+#define CHROME_BROWSER_MAHORAGA_SERVER_SERVER_STATE_STORE_IMPL_H_
+
...
+}  // namespace mahoraga
+
+#endif  // CHROME_BROWSER_MAHORAGA_SERVER_SERVER_STATE_STORE_IMPL_H_
