diff --git a/chrome/browser/mahoraga/server/process_controller.h b/chrome/browser/mahoraga/server/process_controller.h
new file mode 100644
index 0000000000000..08c04e406dac8
--- /dev/null
+++ b/chrome/browser/mahoraga/server/process_controller.h
@@ -0,0 +1,60 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_MAHORAGA_SERVER_PROCESS_CONTROLLER_H_
+#define CHROME_BROWSER_MAHORAGA_SERVER_PROCESS_CONTROLLER_H_
+
+#include <optional>
+
...
+}  // namespace mahoraga
+
+#endif  // CHROME_BROWSER_MAHORAGA_SERVER_PROCESS_CONTROLLER_H_
