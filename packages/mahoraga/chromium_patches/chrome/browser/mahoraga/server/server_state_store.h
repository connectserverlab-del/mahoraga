diff --git a/chrome/browser/mahoraga/server/server_state_store.h b/chrome/browser/mahoraga/server/server_state_store.h
new file mode 100644
index 0000000000000..634ed7b5fb6eb
--- /dev/null
+++ b/chrome/browser/mahoraga/server/server_state_store.h
@@ -0,0 +1,36 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_MAHORAGA_SERVER_SERVER_STATE_STORE_H_
+#define CHROME_BROWSER_MAHORAGA_SERVER_SERVER_STATE_STORE_H_
+
+#include <optional>
+
...
+}  // namespace mahoraga
+
+#endif  // CHROME_BROWSER_MAHORAGA_SERVER_SERVER_STATE_STORE_H_
