diff --git a/chrome/browser/mahoraga/server/server_updater.h b/chrome/browser/mahoraga/server/server_updater.h
new file mode 100644
index 0000000000000..e1d0cfbd93d28
--- /dev/null
+++ b/chrome/browser/mahoraga/server/server_updater.h
@@ -0,0 +1,41 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_MAHORAGA_SERVER_SERVER_UPDATER_H_
+#define CHROME_BROWSER_MAHORAGA_SERVER_SERVER_UPDATER_H_
+
...
+}  // namespace mahoraga
+
+#endif  // CHROME_BROWSER_MAHORAGA_SERVER_SERVER_UPDATER_H_
