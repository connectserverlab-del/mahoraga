diff --git a/chrome/browser/mahoraga/core/mahoraga_prefs.cc b/chrome/browser/mahoraga/core/mahoraga_prefs.cc
new file mode 100644
index 0000000000000..d1e1eea1df751
--- /dev/null
+++ b/chrome/browser/mahoraga/core/mahoraga_prefs.cc
@@ -0,0 +1,128 @@
...
+    pref_service->SetBoolean(::prefs::kVerticalTabsEnabled, mahoraga_enabled);
+  }
+}
+
...
+  const bool mahoraga_enabled = ShouldShowTabGroupsInBookmarkBar(pref_service);
...
+                                 PrefService*) {
+  return IsMahoragaPinnedExtension(extension_id);
+}
+
+}  // namespace mahoraga
