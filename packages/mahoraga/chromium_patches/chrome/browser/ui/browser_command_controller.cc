...
+      }
+      break;
+    case IDC_TOGGLE_MAHORAGA_AGENT: {
+      if (!mahoraga::IsActiveMahoragaExtension(
...
+              nullptr,
+              u"Mahoraga Agent is installing/updating. Please try again "
+              u"shortly.",
+              /*auto_expire=*/true,
+              /*should_animate=*/true,
+              /*closeable=*/true);
...
+      if (service) {
+        std::ignore = service->MahoragaToggleSidePanelForTab(
