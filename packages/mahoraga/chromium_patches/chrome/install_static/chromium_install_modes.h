...
+// and user data directory paths. Per-product so Mahoraga and BrowserClaw get
...
+};
+#else
+inline constexpr wchar_t kProductPathName[] = L"Mahoraga";
+inline constexpr ProductInstallIdentity kProductInstallIdentity = {
+    .base_app_name = L"Mahoraga",
+    .base_app_id = L"Mahoraga",
+    .browser_prog_id_prefix = L"BOSHTML",
+    .browser_prog_id_description = L"Mahoraga HTML Document",
+    .direct_launch_url_scheme = "mahoraga",
+    .pdf_prog_id_prefix = L"BOSPDF",
+    .pdf_prog_id_description = L"Mahoraga PDF Document",
