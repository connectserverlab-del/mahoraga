diff --git a/chrome/utility/importer/mahoraga/chrome_autofill_importer.cc b/chrome/utility/importer/mahoraga/chrome_autofill_importer.cc
new file mode 100644
index 0000000000000..3d1e95eaf3461
--- /dev/null
+++ b/chrome/utility/importer/mahoraga/chrome_autofill_importer.cc
@@ -0,0 +1,79 @@
...
+    if (!base::PathExists(web_data_path)) {
+      LOG(WARNING) << "mahoraga: Web Data file not found";
+      return entries;
+    }
+  }
+
...
+    LOG(WARNING) << "mahoraga: Failed to open database";
