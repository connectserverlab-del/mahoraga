diff --git a/chrome/utility/importer/mahoraga/chrome_cookie_importer.cc b/chrome/utility/importer/mahoraga/chrome_cookie_importer.cc
new file mode 100644
index 0000000000000..21b17a08e1a8e
--- /dev/null
+++ b/chrome/utility/importer/mahoraga/chrome_cookie_importer.cc
@@ -0,0 +1,295 @@
...
+    LOG(WARNING) << "mahoraga: Cookies not found at: " << cookies_path.value();
+    return cookies;
+  }
+
...
+    LOG(WARNING) << "mahoraga: Failed to open Cookies database";
...
+        VLOG(1) << "mahoraga: Skipping cookie " << entry.name << " on "
...
+    LOG(WARNING) << "mahoraga: Cookie import skipped " << skipped_app_bound
