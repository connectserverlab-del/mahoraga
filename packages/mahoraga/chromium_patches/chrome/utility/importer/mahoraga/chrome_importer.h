diff --git a/chrome/utility/importer/mahoraga/chrome_importer.h b/chrome/utility/importer/mahoraga/chrome_importer.h
new file mode 100644
index 0000000000000..5b45173f702b7
--- /dev/null
+++ b/chrome/utility/importer/mahoraga/chrome_importer.h
@@ -0,0 +1,48 @@
+// Copyright 2023 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_IMPORTER_H_
+#define CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_IMPORTER_H_
+
+#include <stdint.h>
+#include <string>
+
...
+};
+
+#endif  // CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_IMPORTER_H_
