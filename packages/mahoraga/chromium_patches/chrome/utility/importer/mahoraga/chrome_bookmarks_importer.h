diff --git a/chrome/utility/importer/mahoraga/chrome_bookmarks_importer.h b/chrome/utility/importer/mahoraga/chrome_bookmarks_importer.h
new file mode 100644
index 0000000000000..40dfcc2ce8af8
--- /dev/null
+++ b/chrome/utility/importer/mahoraga/chrome_bookmarks_importer.h
@@ -0,0 +1,33 @@
+// Copyright 2024 AKW Technology Inc
+// Chrome bookmarks importer
+
+#ifndef CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_BOOKMARKS_IMPORTER_H_
+#define CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_BOOKMARKS_IMPORTER_H_
+
+#include <vector>
+
...
+}  // namespace mahoraga_importer
+
+#endif  // CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_BOOKMARKS_IMPORTER_H_
