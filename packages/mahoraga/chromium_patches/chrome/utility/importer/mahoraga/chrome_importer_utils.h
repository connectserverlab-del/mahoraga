diff --git a/chrome/utility/importer/mahoraga/chrome_importer_utils.h b/chrome/utility/importer/mahoraga/chrome_importer_utils.h
new file mode 100644
index 0000000000000..d7334846286cd
--- /dev/null
+++ b/chrome/utility/importer/mahoraga/chrome_importer_utils.h
@@ -0,0 +1,35 @@
+// Copyright 2024 AKW Technology Inc
+// Chrome importer shared utilities
+
+#ifndef CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_IMPORTER_UTILS_H_
+#define CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_IMPORTER_UTILS_H_
+
...
+}  // namespace mahoraga_importer
+
+#endif  // CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_IMPORTER_UTILS_H_
