diff --git a/chrome/utility/importer/mahoraga/chrome_cookie_importer.h b/chrome/utility/importer/mahoraga/chrome_cookie_importer.h
new file mode 100644
index 0000000000000..b706ed9dfa177
--- /dev/null
+++ b/chrome/utility/importer/mahoraga/chrome_cookie_importer.h
@@ -0,0 +1,53 @@
+// Copyright 2024 AKW Technology Inc
+// Chrome cookie importer interface
+
+#ifndef CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_COOKIE_IMPORTER_H_
+#define CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_COOKIE_IMPORTER_H_
+
+#include <string>
+#include <vector>
+
...
+}  // namespace mahoraga_importer
+
+#endif  // CHROME_UTILITY_IMPORTER_MAHORAGA_CHROME_COOKIE_IMPORTER_H_
