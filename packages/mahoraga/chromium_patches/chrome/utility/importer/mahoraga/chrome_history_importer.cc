diff --git a/chrome/utility/importer/mahoraga/chrome_history_importer.cc b/chrome/utility/importer/mahoraga/chrome_history_importer.cc
new file mode 100644
index 0000000000000..ec7b96bb6b854
--- /dev/null
+++ b/chrome/utility/importer/mahoraga/chrome_history_importer.cc
@@ -0,0 +1,92 @@
...
+    LOG(WARNING) << "mahoraga: History file not found";
+    return rows;
+  }
+
