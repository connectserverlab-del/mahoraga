...
#[command(
    name = "bpatch",
    about = "Manage Mahoraga Chromium patches",
...
"#
    ...
    #[command(
        ...
        after_long_help = r#"EXAMPLES:
  bpatch feature list
  bpatch feature add wallet --path chrome/browser/mahoraga/wallet/
"#
    )]
    Feature(FeatureArgs),
...
"#
    ...
    #[command(
        ...
        after_long_help = r#"EXAMPLE:
  bpatch feature add wallet chrome/browser/mahoraga/wallet/ --desc "feat: wallet"
