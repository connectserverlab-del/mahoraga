#!/usr/bin/env python3
"""Upload module for Mahoraga build artifacts to Cloudflare R2"""
...
def generate_release_json(
    ...
    release_data = {
        ...
        "mahoraga_chromium_version": ctx.mahoraga_chromium_version,
        "build_date": datetime.now(timezone.utc).isoformat(),
        "artifacts": {},
    }

    # Sparkle (macOS) and WinSparkle (Windows) both compare against this
    # epoch-prefixed Mahoraga version in the appcast (Context.get_sparkle_version).
...
def _get_artifact_key(filename: str, platform: str) -> str:
    ...
    Examples:
        Mahoraga_v0.31.0_arm64.dmg -> arm64
        Mahoraga_v0.31.0_x64.dmg -> x64
        Mahoraga_v0.31.0_x64_installer.exe -> x64_installer
        Mahoraga_v0.31.0_x64.AppImage -> x64_appimage
        mahoraga_0.31.0_amd64.deb -> x64_deb
    """
    lower = filename.lower()
