...
class IconGenerationProductPathsTest(unittest.TestCase):
    def test_mahoraga_uses_legacy_source_and_resource_tree(self) -> None:
        self.assertEqual(
            generate_icons.resolve_input_path("source/app_icon.png", "mahoraga"),
            generate_icons.SOURCE_DIR / "app_icon.png",
        )
        self.assertEqual(
            generate_icons.resolve_input_path("static/product_logo.svg", "mahoraga"),
            generate_icons.STATIC_DIR / "product_logo.svg",
        )
        self.assertEqual(
            generate_icons.product_output_dir("mahoraga"),
            generate_icons.RESOURCE_DIR / "mahoraga" / "icons",
        )
