# Mahoraga Icon Generation

This directory contains the unified icon generation system for Mahoraga products. Browser
...
3. **Build Mahoraga**: The `copy_resources.yaml` copies generated icons to chromium source tree
