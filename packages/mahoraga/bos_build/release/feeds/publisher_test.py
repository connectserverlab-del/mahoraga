...
def _artifact(url="https://cdn.mahoraga.com/releases/mahoraga/0.47.0.2/macos/Mahoraga_v0.47.0.2_arm64.dmg"):
    return {
...
class PublisherTestCase(unittest.TestCase):
    ...
    def test_channel_metadata_mismatch_refused(self):
        ...
        ok = publisher.publish(
            server_feed("mahoraga-server", "prod"), alpha_content, publish=True
        )
