...
MAC_ARTIFACT = {
    "filename": "Mahoraga_v0.47.0.2_arm64.dmg",
    "url": "https://cdn.mahoraga.com/releases/mahoraga/0.47.0.2/macos/Mahoraga_v0.47.0.2_arm64.dmg",
    "sparkle_signature": "MACSIG==",
    "sparkle_length": 265462841,
}

WIN_ARTIFACT = {
    "filename": "Mahoraga_v0.47.0.2_x64_installer.exe",
    "url": "https://cdn.mahoraga.com/releases/mahoraga/0.47.0.2/win/Mahoraga_v0.47.0.2_x64_installer.exe",
...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle">
  <channel>
    ...
    <link>https://cdn.mahoraga.com/appcast.xml</link>
    <description>Most recent changes with links to updates.</description>
    <language>en</language>

    <item>
      <title>Mahoraga - 0.47.0.2</title>
      ...
      <link>https://www.mahoraga.com/</link>
      <enclosure
        url="https://cdn.mahoraga.com/releases/mahoraga/0.47.0.2/macos/Mahoraga_v0.47.0.2_arm64.dmg"
...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle">
  <channel>
    <title>Mahoraga Windows Updates</title>
    <link>https://cdn.mahoraga.com/appcast-win.xml</link>
    <description>Most recent changes with links to updates.</description>
    <language>en</language>
...
<rss xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle" version="2.0">
  <channel>
    <title>Mahoraga Claw Server</title>
    <link>https://cdn.mahoraga.com/appcast-claw-server.xml</link>
    <description>Mahoraga Claw Server binary updates</description>
    <language>en</language>
    ...
    <item>
      ...
      <!-- macOS arm64 -->
      <enclosure
        url="https://cdn.mahoraga.com/server/browserclaw_server_0.0.5_darwin_arm64.zip"
        sparkle:os="macos"
        sparkle:arch="arm64"
...
<gupdate xmlns="http://www.google.com/update2/response" protocol="2.0">
  <app appid="adlpneommgkgeanpaekgoaolcpncohkf">
    <updatecheck codebase="https://cdn.mahoraga.com/extensions/bugreporter-54.0.0.0.crx" version="54.0.0.0" />
  </app>
  <app appid="bflpfmnmnokmjhmgnolecpppdbdophmk">
    <updatecheck codebase="https://cdn.mahoraga.com/extensions/agent-0.0.118.0.crx" version="0.0.118.0" />
  </app>
</gupdate>
"""
...
GOLDEN_EXTENSIONS_JSON = """\
{
  "extensions": {
    "adlpneommgkgeanpaekgoaolcpncohkf": {
      "external_update_url": "https://cdn.mahoraga.com/extensions/update-manifest.alpha.xml"
    },
...
class ServerAppcastRenderTest(unittest.TestCase):
    ...
    def test_same_version_merge_keeps_pub_date_and_other_platforms(self):
        spec = server_feed("mahoraga-server", "alpha")
        existing_artifact = SignedArtifact(
            platform="darwin_arm64",
            zip_path=Path("mahoraga_server_0.0.9_darwin_arm64.zip"),
            signature="OLDSIG==",
            length=11,
            os="macos",
            arch="arm64",
        ...
        new_artifact = SignedArtifact(
            platform="linux_x64",
            zip_path=Path("mahoraga_server_0.0.9_linux_x64.zip"),
            signature="NEWSIG==",
            length=22,
            os="linux",
            arch="x86_64",
        ...
        self.assertIn("Mahoraga Server (Alpha)", content)
...
class ExtensionsRenderTest(unittest.TestCase):
    ...
    def test_extensions_json_prod_points_at_prod_manifest(self):
        ...
        self.assertIn(
            "https://cdn.mahoraga.com/extensions/update-manifest.xml", content
        )
...
class VersionHelpersTest(unittest.TestCase):
    ...
    def test_extract_enclosure_urls_covers_appcasts_and_manifests(self):
        self.assertEqual(
            ...
            [
                "https://cdn.mahoraga.com/releases/mahoraga/0.47.0.2/macos/Mahoraga_v0.47.0.2_arm64.dmg"
            ],
        )
        self.assertEqual(
            extract_enclosure_urls(GOLDEN_UPDATE_MANIFEST),
            [
                "https://cdn.mahoraga.com/extensions/bugreporter-54.0.0.0.crx",
                "https://cdn.mahoraga.com/extensions/agent-0.0.118.0.crx",
            ],
        )
    ...
    def test_extract_channel_metadata(self):
        self.assertEqual(
            ...
            ("Mahoraga Windows Updates", "https://cdn.mahoraga.com/appcast-win.xml"),
        )
