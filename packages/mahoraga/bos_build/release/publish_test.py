...
class ReleaseSourceKeyTest(unittest.TestCase):
    def test_uses_metadata_url_when_it_points_at_cdn(self):
        ...
        key = _release_source_key(
            ...
            "0.31.0",
            {
                "filename": "Mahoraga_v0.31.0_x64_installer.exe",
        ...
        self.assertEqual(
            key,
            "releases/0.31.0/win/Mahoraga_v0.31.0_x64_installer.exe",
        )
    ...
    def _ctx(self, product: str) -> Context:
        return cast(
            Context,
            SimpleNamespace(
                env=SimpleNamespace(r2_cdn_base_url="https://cdn.mahoraga.com"),
