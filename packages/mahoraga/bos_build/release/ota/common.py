...
SERVER_PLATFORMS = [
    {"name": "darwin_arm64", "binary": "mahoraga-server-darwin-arm64", "target": "darwin-arm64", "os": "macos", "arch": "arm64"},
    {"name": "darwin_x64", "binary": "mahoraga-server-darwin-x64", "target": "darwin-x64", "os": "macos", "arch": "x86_64"},
    {"name": "linux_arm64", "binary": "mahoraga-server-linux-arm64", "target": "linux-arm64", "os": "linux", "arch": "arm64"},
    {"name": "linux_x64", "binary": "mahoraga-server-linux-x64", "target": "linux-x64", "os": "linux", "arch": "x86_64"},
    {"name": "windows_x64", "binary": "mahoraga-server-windows-x64.exe", "target": "windows-x64", "os": "windows", "arch": "x86_64"},
]
...
def create_server_bundle_zip(resources_dir: Path, output_zip: Path) -> bool:
    ...
    Produces entries like ``resources/bin/mahoraga_server`` and
...
def get_appcast_path(channel: str = "alpha", bundle_id: str = "mahoraga-server") -> Path:
