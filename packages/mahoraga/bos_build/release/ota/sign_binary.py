...
def sign_macos_binary(
    ...
    *,
    ...
    ``identifier`` defaults to ``com.mahoraga.<stem>`` to preserve the
    ...
    resolved_identifier = identifier or f"com.mahoraga.{binary_path.stem}"
    cmd = [
        "codesign",
...
def sign_server_bundle_macos(
    ...
    for path in executables:
        ...
        if not sign_macos_binary(
            ...
            env,
            entitlements_path,
            identifier=f"com.mahoraga.{spec.identifier_suffix}",
