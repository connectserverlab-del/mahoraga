...
def _create_context(version: str = "", product: str = "mahoraga") -> Context:
...
def appcast_command(
    ...
    product: str = typer.Option(
        "mahoraga", "--product", help="Product whose browser feeds to generate"
    ),
    ...
    Dry run (prints full XML + diff vs live):
      mahoraga release appcast --version 0.47.0.2

    \b
    Publish (backs up live feeds to feeds-history/ first):
      mahoraga release appcast --version 0.47.0.2 --publish
    """
