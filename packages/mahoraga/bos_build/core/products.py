...
MAHORAGA_CONTROLLER_EXTENSION_ID = "nlnihljpboknmfagkikhkdblbedophja"
...
class ProductDescriptor:
    ...
    def artifact_filename(self, artifact_type: str, version: str, arch: str) -> str:
        """Standardized artifact filename, e.g. "Mahoraga_v0.31.0_arm64.dmg"."""
    ...
    def define(
        ...
        *,
        ...
        summary: str,
        description: str,
        mac_bundle_domain: str = "com.mahoraga",
        company: str = "Mahoraga",
        homepage_url: str = "https://www.mahoraga.com/",
        support_url: str = "https://docs.mahoraga.com/",
        bugtracker_url: str = "https://github.com/connectserverlab-del/mahoraga/issues",
