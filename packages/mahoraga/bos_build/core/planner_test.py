...
class ReleaseGoldenTest(unittest.TestCase):
    def test_macos_arm64_signed(self):
        # release.mahoraga.macos.arm64.yaml / release.macos.arm64.yaml
        self.assertEqual(
    ...
    def test_windows_signed(self):
        # release.mahoraga.windows.yaml — note sparkle_sign AFTER package
        self.assertEqual(
    ...
    def test_macos_universal(self):
        # release.mahoraga.macos.universal.yaml — three sequential runs on
