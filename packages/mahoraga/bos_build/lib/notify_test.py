...
def _ctx(product="mahoraga", arch="arm64", release_version="", semantic_version="1.2.3"):
...
class SlackRunSubscriberTest(unittest.TestCase):
    ...
    def test_success_includes_release_links_artifacts_field(self):
        ...
        ctx.artifact_registry.add(
            "release_links",
            [
                ("Mahoraga.dmg", "https://example.test/Mahoraga.dmg"),
        ...
        self.assertEqual(
            ...
            {
                "Artifacts": (
                    "<https://example.test/Mahoraga.dmg|Mahoraga.dmg>\n"
    ...
    def test_failure_names_step_phase_error_and_waits(self):
        ...
        self.assertIn("Mahoraga v1.2.3", terminal["title"])
