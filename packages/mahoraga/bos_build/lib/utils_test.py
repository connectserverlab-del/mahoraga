...
class CommandRedactionTest(unittest.TestCase):
    ...
    def test_redacts_credentials_configured_outside_envconfig_properties(self):
        credentials = {
            "MAHORAGA_AGENT_V2_KEY": "FAKE_AGENT_PRIVATE_KEY_FOR_REDACTION_TEST",
            "MAHORAGA_CONTROLLER_KEY": "FAKE_CONTROLLER_KEY_FOR_REDACTION_TEST",
    ...
    def test_streams_multiline_private_key_output_without_leaking_lines(self):
        ...
        with (
            ...
            result = utils.run_command(
                command,
                env={"MAHORAGA_AGENT_V2_KEY": FAKE_PEM_PRIVATE_KEY},
            )
