...
Connect Mahoraga to n8n to build automated workflows. Your n8n AI agents can control the browser—open pages, click buttons, extract data, and fill forms.
...
Before you start:
- Mahoraga running with MCP server enabled (Settings → Mahoraga as MCP)
...
### 4. Connect to Mahoraga

Click on the MCP Client node and configure:

- **Endpoint**: Your Mahoraga MCP URL (find it in Settings → Mahoraga as MCP)
- **Server Transport**: `HTTP Streamable`

<img src="/images/n8n-step5-mcp-client.png" alt="MCP Client configuration with Mahoraga URL" />
...
- Make sure Mahoraga is running
- Check that MCP server is enabled in Mahoraga settings
- Verify the port number matches your Mahoraga MCP URL
