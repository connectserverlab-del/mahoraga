...
<Steps>
  <Step title="Install BrowserClaw">
    Head over to [mahoraga.com/agents](https://mahoraga.com/agents) and download BrowserClaw for your operating system. Install it the way you'd install any other browser.
