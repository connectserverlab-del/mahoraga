...
<video
  ...
  src="https://github.com/connectserverlab-del/mahoraga/releases/download/onboarding-video/v0.1.0/first-run-demo.mp4"
  poster="https://github.com/connectserverlab-del/mahoraga/releases/download/onboarding-video/v0.1.0/first-run-demo-poster.png"
></video>
...
<CardGroup cols={3}>
  <Card title="Download BrowserClaw" icon="download" href="https://mahoraga.com/agents">
