...
If your AI tool supports MCP but isn't on the one-click board, we'd love to add it. Head to [Mahoraga Discussions](https://github.com/orgs/mahoraga-ai/discussions) and open a new discussion. A short template that helps us move fast:
