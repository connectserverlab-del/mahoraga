---
title: "Contributing to Mahoraga"
description: "Guide to contributing to Mahoraga"
---

Mahoraga has two main parts you can contribute to:
...
- [GitHub Repository](https://github.com/Mahoraga-ai/Mahoraga)
- [Discord Community](https://discord.gg/YKwjt5vuKr)
- [Report Issues](https://github.com/Mahoraga-ai/Mahoraga/issues)

## Ways to Contribute

**Report bugs** — [Open an issue](https://github.com/connectserverlab-del/mahoraga/issues/new) with steps to reproduce, expected vs actual behavior, and screenshots.

**Suggest features** — Share ideas on [GitHub](https://github.com/connectserverlab-del/mahoraga/issues/99) or [Discord](https://discord.gg/YKwjt5vuKr).
...
<img src="/images/contributing--architecture.png" alt="Mahoraga Agent architecture diagram" />

### Setup

```bash
# Clone the repo
git clone https://github.com/YOUR-USERNAME/Mahoraga.git
cd Mahoraga/packages/mahoraga-agent
...
Then load the extension in Mahoraga:
...
```bash
uv run mahoraga build --chromium-src <path> --build --build-type debug
```
...
<Tabs>
  <Tab title="macOS (ARM64)">
    ```bash
    <chromium-src>/out/Default_arm64/Mahoraga\ Dev.app/Contents/MacOS/Mahoraga\ Dev \
  ...
  <Tab title="macOS (x64)">
    ```bash
    <chromium-src>/out/Default_x64/Mahoraga\ Dev.app/Contents/MacOS/Mahoraga\ Dev \
      --enable-logging=stderr \
      --use-mock-keychain \
      --user-data-dir=/tmp/test-profile
    ```
  ...
  <Tab title="Windows">
    ```bash
    <chromium-src>\out\Default_x64\Mahoraga Dev.exe \
      --enable-logging=stderr \
  ...
  <Tab title="Linux">
    ```bash
    <chromium-src>/out/Default_x64/mahoraga \
      --enable-logging=stderr \
      --user-data-dir=/tmp/test-profile
    ```
  </Tab>
...
- **GitHub Issues** — [github.com/Mahoraga-ai/Mahoraga/issues](https://github.com/Mahoraga-ai/Mahoraga/issues)
- **GitHub Discussions** — [github.com/Mahoraga-ai/Mahoraga/discussions](https://github.com/Mahoraga-ai/Mahoraga/discussions)
