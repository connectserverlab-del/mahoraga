...
description: "Set up Mahoraga in 2 minutes"
---

Welcome to Mahoraga! Let's get you set up.
...
<Steps>
  ...
  <Step title="Set up your AI">
    Mahoraga includes a default AI model with limited daily usage. For the best experience, add your own.
...
<Tip>
**Block ads with uBlock Origin** — Chrome dropped support for the full uBlock Origin extension, but Mahoraga brought it back. [Install it from the Chrome Web Store](https://chromewebstore.google.com/detail/ublock-origin/cjpalhdlnbpafiamejdnhcphjbkeiagm) and browse ad-free. [Learn more →](/features/ad-blocking)
</Tip>

Explore what Mahoraga can do:
...
<Columns cols={2}>
  ...
  <Card title="Use with Claude Code" icon="terminal" href="/features/use-with-claude-code">
    Control Mahoraga from Claude Code or Gemini CLI
  </Card>
</Columns>
