...
<Frame>
  <img src="/images/hero-dark.png" alt="Mahoraga in action" />
</Frame>

Mahoraga is an AI-native browser that lets you automate any web task by describing it in plain English. Built on Chromium, it runs AI agents locally on your machine—keeping your data private while giving you superpowers for browsing.
...
<Steps>
  <Step title="Download Mahoraga">
    Get the latest release from [mahoraga.com](https://mahoraga.com) for macOS, Windows, or Linux.
  </Step>
  ...
  <Step title="Configure your AI">
    Mahoraga includes a default AI model with limited daily usage for testing. For the full experience, bring your own API keys.
...
<Columns cols={3}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/Mahoraga-ai/Mahoraga">
    Star us and contribute
  </Card>
  <Card title="Twitter" icon="x-twitter" href="https://x.com/mahoraga_ai">
    Follow for updates
  </Card>
</Columns>
