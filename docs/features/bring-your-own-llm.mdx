...
description: "Connect your own AI models to Mahoraga"
---

Mahoraga includes a default AI model you can use right away, but it has strict rate limits. For the best experience, bring your own API keys or run models locally.
...
Already paying for ChatGPT Pro or GitHub Copilot? Connect your existing account to Mahoraga with a single sign-in — no API keys, no extra cost.
...
{/* <img src="/images/moonshot-partnership-banner.png" alt="Mahoraga x Moonshot AI" className="rounded-xl" /> */}

Mahoraga has partnered with [Moonshot AI](https://www.kimi.com) to bring **Kimi K2.5** as a first-class provider. Kimi K2.5 is now the **recommended model** in Mahoraga and is set as the default provider.

For a limited time, Mahoraga users get **extended usage limits** powered by Kimi K2.5. This means you can use the AI agent, chat, and other AI-powered features with increased limits at no cost.
...
**Add to Mahoraga:**
1. Go to `chrome://mahoraga/settings`
