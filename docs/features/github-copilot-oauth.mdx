...
description: "Use your GitHub Copilot subscription to power Mahoraga"
---

Connect your GitHub Copilot subscription to Mahoraga and access 19+ models — including Claude, GPT-5, and Gemini — through a single GitHub sign-in. No API keys needed.
...
**1.** Open Mahoraga and go to **Settings** (`chrome://mahoraga/settings`). You'll see the AI Providers section.
...
**4.** Paste the device code and authorize Mahoraga to access your Copilot subscription.
