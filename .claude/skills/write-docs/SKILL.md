---
name: write-docs
description: Write Mahoraga feature documentation. Use when the user wants to create or update documentation for a Mahoraga feature. This skill explores the codebase to understand features and writes concise Mintlify MDX docs.
allowed-tools: Read, Grep, Glob, Bash, Task, Write, Edit
---

# Write Mahoraga Documentation

This skill helps write documentation for Mahoraga features. It follows a structured workflow to create high-quality, concise documentation pages.
...
2. **Search the codebase** at `../mahoraga-server` (sibling directory) to find relevant code:
...
- **Clear**: Write for first-time Mahoraga users
...
---
title: "Ad Blocking"
description: "Mahoraga blocks 10x more ads than Chrome out of the box"
---

Mahoraga ships with built-in ad blocking that works immediately—no extensions required.
...
- **Docs location**: `docs/`
- **Images**: `docs/images/`
- **Feature code**: `../mahoraga-server/` (sibling directory)
- **Config**: `docs/docs.json`

## Core Features to Document

The user mentioned these features need documentation:
1. Mahoraga MCP Server
2. Connecting other MCPs to Mahoraga assistant
3. Scheduled tasks
